...
#define SPO2MAXVALUE  256
#define RESPMAXVALUE 0xff
...
#define WM_DRAW_RESP_WAVE     (WM_USER+103)

#define WM_DRAW_SPO2_WAVE     (WM_USER+104)
...
#define WM_DRAW_ECG_WAVE      (WM_USER+111)
